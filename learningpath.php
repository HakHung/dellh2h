        ...
        <div class='row'>
            <nav class='navbar navbar-expand-lg navbar-light my-3 ml-0'>
                <form class='form-inline '>
                    ...
                    <a href='training.html'><button class='btn btn-outline-primary mr-5'
                            type='button'>Trainings</button></a>
                    <a href='volunteer.html'><button class='btn btn-outline-primary mr-5'
                            type='button'>Events</button></a>
